...
class SystemConfig extends Component {
    ...
    saveDeveloper() {
        ...
        axios.post('/configSystem', {
            ...
            "url": _this.state.url,
            "systemName": _this.state.systemName
        })
            .then(function (response) {
                response = response.data;
                if (response.errorCode === "0") {
    ...
    render() {
        ...
        return (
            <div>
                <p style={{fontSize: "28px", textAlign: "center"}}>系统接入方信息配置</p>
                <Row>
                    ...
                    <Col span={colSpan.right} style={colSpan.styleRight}>
                        {this.state.id}<br/>
                        (SystemId是平台开发接入识别码，配合开发者公钥可调用接口)
                    </Col>
                </Row>
                <br/>
                <Row>
                    <Col span={colSpan.left} style={colSpan.styleLeft}>服务器地址(URL) : </Col>
                    <Col span={colSpan.right} style={colSpan.styleRight}>
                ...
                <br/>
                <Row>
                    <Col span={colSpan.left} style={colSpan.styleLeft}>系统名称 : </Col>
                    <Col span={colSpan.right} style={colSpan.styleRight}>
                        <Input value={this.state.systemName} onChange={(e) => {
                ...
                <br/>
                <Row>
                    <Col span={colSpan.left} style={colSpan.styleLeft}>应用公钥 : </Col>
                    <Col span={colSpan.right} style={colSpan.styleRight}>
                        <Input value={this.state.publicKey} onChange={(e) => {
                ...
                <Row>
                    ...
                    <Col span={colSpan.right} style={colSpan.styleRight}>
                        <Button type="primary" style={{width: '150px'}}
                                onClick={this.saveDeveloper.bind(this)}>保存</Button>
                    </Col>
                </Row>
            </div>
        )
